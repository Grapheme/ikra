		...
		<div class="h2">Наши курсы <br> в
			<form class="nl-form _text-violet" data-nl>
				...
				<select name="subject" id="">
					<option value="1">Креативу</option>
	...
	<section class="b-section _bg-red">
		...
		<ul class="_mb50 row">
			<li class="col-sm-6 col-md-4 _mb30">
				...
				<div class="_mb5 h3">Имя Фамилия</div>
				<div class="small">должность, компания</div>
			</li>
			<li class="col-sm-6 col-md-4 _mb30">
				<a class="_block _mb20" href="#">
					<img src="img/content/512.jpg" alt="">
		...
		<div class="row">
			<div class="col-sm-6 col-sm-offset-6 col-md-4 col-md-offset-8">
				<span class="_text-red"><a href="#" class="btn btn-white btn-wide">Все преподаватели</a></span>
			</div>
		</div>
	</section>
	...
	<section class="b-section _no-padding-bottom">
		...
		<ul class="_mb50 row">
			<li class="col-sm-6 _mb30">
				<a class="_block _mb20" href="#">
					<img class="" src="img/content/1024.jpg" alt="">
				</a>
				<div class="h3 _mb5">Имя Фамилия</div>
				<div class="small _mb20">должность, компания</div>
				<div class="_mb20">
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate sint, illo sit id sequi mollitia iusto maiores aperiam quidem ducimus repudiandae optio molestias eveniet, excepturi totam? Iure reprehenderit alias enim.
				</div>
				<div class="h4">
					Учился: <b class="_text-yellow">профессия digital-стратег '13/1</b>
				</div>
			</li>
			<li class="col-sm-6 _mb30">
				<a class="_block _mb20" href="#">
				...
				<div class="h4">
					Училась: <b class="_text-red">основной курс '13/1</b>
				</div>
			</li>
		</ul>
		...
		<div class="row">
			<div class="col-sm-6 col-sm-offset-6 col-md-4 col-md-offset-8 text-right">
				<a href="#" class="btn btn-blue">Ещё про выпускников</a>
			</div>
		</div>
	</section>
