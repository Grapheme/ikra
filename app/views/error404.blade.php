...
@section('content')
    ...
    <main>
        <div class="slideshow">
            <div class="slide">
                <div class="slide-bg" style="background-image: url({{asset('theme/site/img/pages/pussy404.jpg')}});"></div>
                <section class="slide-cont" style="margin-top: 15.1%;">
                    <header>
                        <div class="slide-logo" style="background: url({{asset('theme/site/img/pages/pussy404.jpg')}}); width: 215px; height: 96px;">
