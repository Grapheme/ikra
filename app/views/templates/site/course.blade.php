        ...
        <section class="b-section _no-padding-bottom">
            <div class="row">
                <div class="col-md-4 _mb60" data-equalheight>
                    <a class="_block _mb10 course-teacher-avatar" style="background-image: url({{ (isset($teacher->avatar) && is_object($teacher->avatar)) ? $teacher->avatar->full() : '' }});" href="{{ URL::route('page.teacher', [$teacher->id]) }}">
