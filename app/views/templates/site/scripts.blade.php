...
{{ HTML::scriptmod(Config::get('site.theme_path').'/js/libs/jquery-validation/dist/jquery.validate.min.js') }}
{{ HTML::scriptmod(Config::get('site.theme_path').'/js/libs/owl.carousel.min.js') }}
{{ HTML::scriptmod(Config::get('site.theme_path').'/js/libs/jquery.jcarousel.min.js') }}
{{ HTML::scriptmod(Config::get('site.theme_path').'/js/libs/jcarousel.skeleton.js') }}
{{ HTML::scriptmod(Config::get('site.theme_path').'/js/libs/jquery.form.js') }}
