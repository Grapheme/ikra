...
")
    ...
    'hooks' => array(
         ...
         * Также вызывается в начале методов create и edit
         */
...
,
    ...
    /**
     * Данный параметр определяет, куда будет переадресован пользователь после создания нового элемента.
     * Возможные значения:
     * - list - список элементов
     * - new - страница редактирования нового элемента (по умолчанию)
     * - ['route_name' => 'entity.create', 'route_params' => ['dic_slug' => 'ksp'], 'add_query_string' => true]
     */
